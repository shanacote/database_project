...
import { faUserSecret, faPencilAlt } from '@fortawesome/free-solid-svg-icons' //https://fontawesome.com/v5.15/icons?d=gallery&p=2&s=solid&m=free
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'

library.add(faUserSecret, faPencilAlt)
